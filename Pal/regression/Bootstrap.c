...
int main(int argc, char** argv, char** envp) {
    ...
    pal_printf("CPU cpu: %s\n", pal_public_state->cpu_info.cpu);
    pal_printf("CPU clock: %s\n", pal_public_state->cpu_info.clock);
    pal_printf("CPU revision: %s\n", pal_public_state->cpu_info.revision);
    pal_printf("CPU timebase: %s\n", pal_public_state->cpu_info.timebase);
    pal_printf("CPU platform: %s\n", pal_public_state->cpu_info.platform);
    pal_printf("CPU model: %s\n", pal_public_state->cpu_info.model);
    pal_printf("CPU machine: %s\n", pal_public_state->cpu_info.machine);
    pal_printf("CPU firmware: %s\n", pal_public_state->cpu_info.firmware);
    pal_printf("CPU MMU: %s\n", pal_public_state->cpu_info.mmu);
#else
