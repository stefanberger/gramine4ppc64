...
#define LOAD_ARGS_1(a1)           \
    ...
    LOAD_ARGS_0()
#define LOAD_REGS_1                               \
    register long int _a1 __asm__("r3") = __arg1; \
    LOAD_REGS_0
...
#define LOAD_ARGS_2(a1, a2)       \
    ...
    LOAD_ARGS_1(a1)
#define LOAD_REGS_2                               \
    register long int _a2 __asm__("r4") = __arg2; \
    LOAD_REGS_1
...
#define LOAD_ARGS_3(a1, a2, a3)   \
    ...
    LOAD_ARGS_2(a1, a2)
#define LOAD_REGS_3                               \
    register long int _a3 __asm__("r5") = __arg3; \
    LOAD_REGS_2
...
#define LOAD_REGS_4                               \
    register long int _a4 __asm__("r6") = __arg4; \
    LOAD_REGS_3
...
#define LOAD_REGS_5                               \
    register long int _a5 __asm__("r7") = __arg5; \
    LOAD_REGS_4
...
#define LOAD_REGS_6                               \
    register long int _a6 __asm__("r8") = __arg6; \
    LOAD_REGS_5
