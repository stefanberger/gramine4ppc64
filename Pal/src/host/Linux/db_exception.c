...
#define SIGHANDLER_NAME(FUNCNAME)	_ ## FUNCNAME
#define SIGHANDLER_STATIC
#else
#define SIGHANDLER_WRAPPER(FUNCNAME)
#define SIGHANDLER_NAME(FUNCNAME)	FUNCNAME
#define SIGHANDLER_STATIC		static
#endif
...
SIGHANDLER_STATIC void SIGHANDLER_NAME(_DkGenericSighandler)
...
SIGHANDLER_STATIC void SIGHANDLER_NAME(_DkTerminateSighandler)
                                   (int signum, siginfo_t * info,
                                    struct ucontext * uc)
{
    __UNUSED(info);
...
SIGHANDLER_STATIC void SIGHANDLER_NAME(_DkPipeSighandler)
                              (int signum, siginfo_t * info,
                               struct ucontext * uc)
{
    __UNUSED(signum);
...
SIGHANDLER_WRAPPER(_DkTerminateSighandler);
SIGHANDLER_WRAPPER(_DkGenericSighandler);
SIGHANDLER_WRAPPER(_DkPipeSighandler);
