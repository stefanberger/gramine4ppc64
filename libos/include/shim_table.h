...
long libos_syscall_clock_nanosleep_time64(clockid_t clock_id, int flags, struct timespec64* req,
                                          struct timespec64* rem);
#endif
#if defined(__NR_clock_gettime64)
long libos_syscall_clock_gettime64(clockid_t which_clock, struct timespec64* tp);
#endif
#if defined(__NR_clock_getres_time64)
long libos_syscall_clock_getres_time64(clockid_t which_clock, struct timespec64* tp);
#endif
