...
struct parser_table {
...
} syscall_parser_table[/*LIBOS_SYSCALL_BOUND*/] =
    {
        ...
        [__NR_select] = {.slow = 0, .parser = {NULL}},                           /* select */
        ...
        [__NR_mknod] = {.slow = 0, .parser = {NULL}},                      /* mknod */
        ...
        [__NR_mknodat] = {.slow = 0, .parser = {&parse_at_fdcwd}}, /* mknodat */
        ...
        [__NR_pselect6] = {.slow = 0, .parser = {NULL}}, /* pselect6 */
