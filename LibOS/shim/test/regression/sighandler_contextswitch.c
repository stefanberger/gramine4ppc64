...
#define VSCR_MAIN               0x00000001UL
#define VSCR_HANDLER            0x00000080UL
...
static void __attribute__((noinline)) set_vsr(unsigned long lo, unsigned long hi) {
    ...
    __asm__ __volatile__ (
        "li 10, 0\n\t"
        "mr 11, %0\n\t"
        "lxvd2x " stringify(VSR_REG) ", 11, 10\n\t"
        :
        : "r" (&data)
        : "r10", "r11", stringify(VSR_REG)
    );
}
...
static void __attribute__((noinline)) get_vsr(unsigned long *lo, unsigned long *hi) {
    ...
    __asm__ __volatile__ (
        "li 10, 0\n\t"
        "mr 11, %0\n\t"
        "stxvd2x " stringify(VSR_REG) ", 11, 10\n\t"
        :
        : "r" (&data)
        : "r10", "r11", "memory"
    );
...
static void __attribute__((noinline)) set_vsr2(unsigned long lo, unsigned long hi) {
    ...
    __asm__ __volatile__ (
        "li 10, 0\n\t"
        "mr 11, %0\n\t"
        "lxvd2x " stringify(VSR2_REG) ", 11, 10\n\t"
        :
        : "r" (&data)
        : "r10", "r11", stringify(VSR2_REG)
    );
}
...
static void __attribute__((noinline)) get_vsr2(unsigned long *lo, unsigned long *hi) {
    ...
    __asm__ __volatile__ (
        "li 10, 0\n\t"
        "mr 11, %0\n\t"
        "stxvd2x " stringify(VSR2_REG) ", 11, 10\n\t"
        :
        : "r" (&data)
        : "r10", "r11", "memory"
    );
