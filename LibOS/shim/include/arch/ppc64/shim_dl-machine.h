 ...
 * shim_dl-machine.h
 *
 * This file contains ppc64-specific codes for relocating ELF binaries.
...
#define debug_reloc(...) ({})
    ...
    if (r_type == R_PPC64_RELATIVE || r_type == R_PPC64_NONE)
        return false;
    ...
    *reloc_addr      = value + ((r_type == R_PPC64_GLOB_DAT || r_type == R_PPC64_JMP_SLOT /*||
                            r_type == R_PPC64_PLT64*/)
                               ? reloc->r_addend
                               : 0);
