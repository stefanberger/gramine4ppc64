...
static inline uint64_t shim_fs_base_to_r13(uint64_t fs_base) {
    return pal_tcb_to_r13((PAL_TCB*)fs_base);
}
...
/* On ppc64 the fs_base (PAL_TCB*) needs to be offset adjusted from plain tls, which is prepared
