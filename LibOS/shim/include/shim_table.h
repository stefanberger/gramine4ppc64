...
long __shim_send(long, long, long, long);
...
long __shim_socketcall(long, long);
...
long __shim_ipc(long, long, long, long, long, long);
...
long __shim_futex_time64(long, long, long, long, long, long);
...
ssize_t shim_do_send(int fd, const void* buf, size_t len, int flags);
...
int shim_do_socketcall(int call, unsigned long *args);
#if defined(__i386__) || defined(__x86_64__)
...
int shim_do_ipc(unsigned int call, int first, unsigned long second, unsigned long third,
                void* ptr, long fifth);
...
int shim_do_futex_time64(int* uaddr, int op, int val, void* utime, int* uaddr2, int val3);
