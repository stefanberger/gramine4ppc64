...
off_t shim__llseek(int fd, unsigned long offset_high, unsigned long offset_low,
                   unsigned long resultaddr, int origin);
...
int shim_socketcall(int call, unsigned long *args);
...
pid_t shim_waitpid(pid_t pid, int* stat_addr, int option);
...
int shim_ipc(unsigned int call, int first, unsigned long second, unsigned long third,
             void* ptr, long fifth);
...
int shim_sigpending(__sigset_t *set);
