...
static inline uint64_t pal_tcb_to_r13(PAL_TCB* tcb) {
    if (tcb)
        return (uint64_t)tcb + TLS_PAL_TCB_OFFSET;
    return 0;
}
 ...
 * The stack needs to be adjusted by 128 (__SIGNAL_FRAMESIZE):
 *  https://elixir.bootlin.com/linux/v5.19.3/source/arch/powerpc/kernel/signal_64.c#L931
 * Typically setup_trampoline would do this upon return from sighandler func:
 *  https://elixir.bootlin.com/linux/v5.19.3/source/arch/powerpc/kernel/signal_64.c#L621
 */
